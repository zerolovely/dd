...
[[ "$ddMode" == '1' ]] && {
  export SSL_SUPPORT='https://raw.githubusercontent.com/zerolovely/dd/master/lib/wget_udeb_amd64.tar.gz';
  if [[ -n "$tmpURL" ]]; then
    DDURL="$tmpURL"
...
[[ -z "$myPASSWORD" ]] && myPASSWORD='$1$MF56HotU$C3sTm9nGvTDmOzS2Jhc6a1';
